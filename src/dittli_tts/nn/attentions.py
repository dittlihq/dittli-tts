        ...
        **kwargs,
        ...
        for i in range(self.n_layers):
            ...
            self.encdec_attn_layers.append(
                MultiHeadSelfAttention(hidden_channels, hidden_channels, n_heads, p_dropout=p_dropout)
            )
            self.norm_layers_1.append(ChannelLayerNorm(hidden_channels))
            self.ffn_layers.append(
                FeedForward(
...
class MultiHeadSelfAttention(nn.Module):
    ...
    def _relative_position_to_absolute_position(self, x):
        ...
        x_flat = F.pad(x_flat, commons.flatten_pad_shape([[0, 0], [0, 0], [0, length - 1]]))
    ...
    def _absolute_position_to_relative_position(self, x):
        batch, heads, length, _ = x.size()
        x = F.pad(x, commons.flatten_pad_shape([[0, 0], [0, 0], [0, 0], [0, length - 1]]))
